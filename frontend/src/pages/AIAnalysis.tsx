...
export const AIAnalysis = () => {
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 p-8 bg-black border border-red-900/30 rounded-[2rem]">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <div className="relative">
            <select
              ...
              className="appearance-none bg-red-950/10 border border-red-900/30 text-white text-sm font-bold rounded-xl focus:ring-red-500 focus:border-red-500 block w-full lg:w-64 p-3 pr-10"
            >
          ...
          <Button
            ...
            className="h-12 px-8 rounded-xl bg-red-600 hover:bg-red-700 text-white font-bold shadow-xl shadow-red-950/50 active:scale-95 transition-all flex items-center space-x-2"
          >
      ...
      <AnimatePresence mode="wait">
        {analysisMutation.isPending ? (
               ...
               <Card className="border border-red-900/20 shadow-premium bg-black">
                  <CardContent className="pt-6">
                     <div className="flex items-center space-x-3 mb-4">
                        <div className="w-10 h-10 rounded-xl bg-red-950/20 flex items-center justify-center">
                    ...
                    <Card key={idx} className="border border-red-900/10 shadow-premium overflow-hidden bg-black">
                      ...
                      <CardContent className="p-8">
                        <div className="prose prose-invert max-w-none">
                          <div className="flex items-start space-x-4 p-5 bg-red-950/10 rounded-2xl border border-red-900/20 mb-8">
                             <div className="w-10 h-10 min-w-[40px] bg-black border border-red-900/20 rounded-xl shadow-sm flex items-center justify-center">
                  ...
                  <Card className="border border-red-900/30 shadow-premium bg-black text-white overflow-hidden">
                     ...
                     <CardContent className="p-6">
                        <div className="space-y-4">
                           <div className="p-4 bg-red-950/10 rounded-xl border border-red-900/20">
          ...
          <motion.div
            ...
            className="flex flex-col items-center justify-center py-24 text-center bg-black border border-red-900/20 border-dashed rounded-[2rem]"
          >
